...
def prune_old_data() -> dict:
    """Safely reclaim generated forecast-path storage.

    Historical market, stack, and regime tables are canonical inputs for the
    stack model, MRS residuals, VLSTM features, and backtests. They must not be
    truncated or time-pruned by an automatic retention job.
    """
