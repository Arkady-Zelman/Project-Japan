...
def prune_old_data() -> dict:
    ...
    Canonical historical tables power backtests, model training, stack/regime
    calibration, and dashboard history. Nightly retention is therefore limited
    to generated forecast runs, which are reproducible and intentionally bulky.
    """
...
def stack_run_daily() -> dict:
    ...
    # market/stack/regime history is preserved for backtests and model training.
    try:
        prune_nightly.spawn()
